...
SECRET_KEY = '39ca@z@-a@q5!w!9_93d@%(07g_&r89a^9bbke^%vc(z@gj550'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(os.path.dirname(os.path.dirname(__file__)), 'CoPlat/templates').replace('\\','/'),],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
