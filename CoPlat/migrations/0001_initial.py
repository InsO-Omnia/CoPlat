# -*- coding: utf-8 -*-
# Generated by Django 1.9.7 on 2016-07-05 01:56
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Category', models.CharField(choices=[('handouts', 'HANDOUTS'), ('vedio', 'VEDIO'), ('uncategoried', 'UNCATEGORIED'), ('documentation', 'DOCUMENTATION')], default='uncategoried', max_length=20)),
                ('course', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='CoPlat.Course')),
            ],
        ),
        migrations.CreateModel(
